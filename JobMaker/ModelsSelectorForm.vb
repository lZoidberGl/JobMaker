Public Class ModelsSelectorForm
    Private Sub ModelsSelectorForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub sourcesite_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles sourcesite.LinkClicked
